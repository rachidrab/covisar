...
@RestController
@RequestMapping("/api/covisar-kafka")
public class CovisarKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CovisarKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CovisarKafkaResource(KafkaProperties kafkaProperties) {
